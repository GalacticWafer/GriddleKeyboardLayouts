...
private val _NOThumbKey_button0_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("h")),
		gesture(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("z")),
		gesture(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("q")),
	)
)
...
private val _NOThumbKey_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("v")),
	)
)
private val _NOThumbKey_button1_1 = makeClassicGestureButton(
	rowStart = 1, colStart = 1, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeStrings = caseSensitive("d")),
		gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("j")),
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("y")),
		...
		gesture(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("å")),
		gesture(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("b")),
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("f")),
		gesture(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive("æ")),
	)
)
private val _NOThumbKey_button1_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("g")),
	)
)
private val _NOThumbKey_button2_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("m")),
	)
)
private val _NOThumbKey_button2_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("k")),
		gesture(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("x")),
		gesture(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("w")),
	)
)
private val _NOThumbKey_button2_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("l")),
	)
)