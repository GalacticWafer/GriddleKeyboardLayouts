...
private val _ENDEMessagEase_button0_0 = makeClassicGestureButton(
	rowStart = 0, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		bind(CLICK, simpleInput, threeStrings = caseSensitive("a")),
		bind(SWIPE_UP, simpleInput, threeStrings = caseSensitive("ö")),
		bind(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("ß")),
		bind(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("ä")),
		bind(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("ü")),
...
private val _ENDEMessagEase_button0_1 = makeClassicGestureButton(
...
private val _ENDEMessagEase_button0_2 = makeClassicGestureButton(
...
private val _ENDEMessagEase_button1_0 = makeClassicGestureButton(
...
private val _ENDEMessagEase_button1_1 = makeClassicGestureButton(
	rowStart = 1, colStart = 1, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		bind(CLICK, simpleInput, threeStrings = caseSensitive("o")),
		...
		bind(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("d")),
		bind(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive("j")),
	)
)
private val _ENDEMessagEase_button1_2 = makeClassicGestureButton(
...
private val _ENDEMessagEase_button2_0 = makeClassicGestureButton(
...
private val _ENDEMessagEase_button2_1 = makeClassicGestureButton(
...
private val _ENDEMessagEase_button2_2 = makeClassicGestureButton(
