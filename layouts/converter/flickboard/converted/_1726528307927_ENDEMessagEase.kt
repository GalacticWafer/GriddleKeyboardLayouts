...
private val _ENDEMessagEase_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		bind(SWIPE_UP, simpleInput, threeChars = caseSensitive("ö")),
		bind(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("ß")),
		bind(SWIPE_LEFT, simpleInput, threeChars = caseSensitive("ä")),
		bind(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ü")),
...
private val _ENDEMessagEase_button1_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		bind(CLICK, simpleInput, threeChars = caseSensitive("o")),
		...
		bind(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("d")),
