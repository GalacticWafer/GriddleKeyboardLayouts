...
private val _FRMessagEase_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("à")),
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("â")),
...
private val _FRMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeStrings = caseSensitive("u")),
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("û")),
...
private val _FRMessagEase_button2_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("ê")),
		gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("y")),
		gesture(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("è")),
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("ù")),
	)
)
