...
private val _FRMessagEase_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("à")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("â")),
...
private val _FRMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeChars = caseSensitive("u")),
		gesture(SWIPE_UP, simpleInput, threeChars = caseSensitive("û")),
...
private val _FRMessagEase_button2_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP, simpleInput, threeChars = caseSensitive("ê")),
		gesture(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("y")),
		gesture(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("è")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ù")),
	)
)
