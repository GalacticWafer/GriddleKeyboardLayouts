...
private val _FRMessagEase_button0_0 = makeClassicGestureButton(
	rowStart = 0, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gestureSet(CLICK, simpleInput, threeChars = caseSensitive("a")),
		gestureSet(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("à")),
		gestureSet(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("â")),
		gestureSet(SWIPE_DOWN_RIGHT, simpleInput, threeChars = caseSensitive("v")),
	)
)
private val _FRMessagEase_button0_1 = makeClassicGestureButton(
...
private val _FRMessagEase_button0_2 = makeClassicGestureButton(
...
private val _FRMessagEase_button1_0 = makeClassicGestureButton(
	rowStart = 1, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gestureSet(CLICK, simpleInput, threeChars = caseSensitive("u")),
		gestureSet(SWIPE_UP, simpleInput, threeChars = caseSensitive("û")),
...
private val _FRMessagEase_button1_1 = makeClassicGestureButton(
...
private val _FRMessagEase_button1_2 = makeClassicGestureButton(
...
private val _FRMessagEase_button2_0 = makeClassicGestureButton(
	rowStart = 2, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gestureSet(CLICK, simpleInput, threeChars = caseSensitive("t")),
		gestureSet(SWIPE_UP, simpleInput, threeChars = caseSensitive("ê")),
		gestureSet(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("y")),
		gestureSet(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("è")),
		gestureSet(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ù")),
	)
)
private val _FRMessagEase_button2_1 = makeClassicGestureButton(
...
private val _FRMessagEase_button2_2 = makeClassicGestureButton(
