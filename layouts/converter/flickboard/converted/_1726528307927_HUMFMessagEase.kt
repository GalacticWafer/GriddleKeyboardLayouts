...
private val _HUMFMessagEase_button0_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("í")),
	)
)
private val _HUMFMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("ö")),
		gesture(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("k")),
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("ó")),
		gesture(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive("ő")),
	)
)
...
private val _HUMFMessagEase_button1_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("ü")),
		gesture(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("m")),
		gesture(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("ű")),
	)
)
