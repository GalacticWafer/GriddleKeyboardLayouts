...
private val _HUMFMessagEase_button0_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("í")),
	)
)
private val _HUMFMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("ö")),
		gesture(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("k")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ó")),
		gesture(SWIPE_DOWN_RIGHT, simpleInput, threeChars = caseSensitive("ő")),
	)
)
...
private val _HUMFMessagEase_button1_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_LEFT, simpleInput, threeChars = caseSensitive("ü")),
		gesture(SWIPE_LEFT, simpleInput, threeChars = caseSensitive("m")),
		gesture(SWIPE_DOWN_LEFT, simpleInput, threeChars = caseSensitive("ű")),
	)
)
