...
private val _NumMini_button4_0 = makeClassicGestureButton(
	rowStart = 4, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
	)
)
private val _NumMini_button5_0 = makeClassicGestureButton(
	rowStart = 5, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
	)
)
private val _NumMini_button6_0 = makeClassicGestureButton(
	rowStart = 6, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
	)
)
private val _NumMini_button7_0 = makeClassicGestureButton(
