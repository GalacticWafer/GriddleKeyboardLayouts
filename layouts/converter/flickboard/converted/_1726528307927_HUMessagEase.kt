...
private val _HUMessagEase_button0_0 = makeClassicGestureButton(
	rowStart = 0, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeChars = caseSensitive("a")),
		gesture(SWIPE_UP, simpleInput, threeChars = caseSensitive("á")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ú")),
		gesture(SWIPE_DOWN_RIGHT, simpleInput, threeChars = caseSensitive("v")),
	)
)
private val _HUMessagEase_button0_1 = makeClassicGestureButton(
...
private val _HUMessagEase_button0_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("ó")),
		gesture(SWIPE_DOWN_LEFT, simpleInput, threeChars = caseSensitive("x")),
	)
)
private val _HUMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ű")),
	)
)
private val _HUMessagEase_button1_1 = makeClassicGestureButton(
...
private val _HUMessagEase_button1_2 = makeClassicGestureButton(
...
private val _HUMessagEase_button2_0 = makeClassicGestureButton(
...
private val _HUMessagEase_button2_1 = makeClassicGestureButton(
...
private val _HUMessagEase_button2_2 = makeClassicGestureButton(
