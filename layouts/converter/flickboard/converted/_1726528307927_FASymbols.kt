...
private val _FASymbols_button0_0 = makeClassicGestureButton(
...
private val _FASymbols_button0_1 = makeClassicGestureButton(
...
private val _FASymbols_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		bind(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("‘")),
		bind(SWIPE_UP, simpleInput, threeStrings = caseSensitive("ˇ")),
		bind(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("’")),
		bind(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("×")),
		bind(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("¡")),
		bind(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("–")),
...
private val _FASymbols_button1_0 = makeClassicGestureButton(
...
private val _FASymbols_button1_1 = makeClassicGestureButton(
	rowStart = 1, colStart = 1, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
	)
)
private val _FASymbols_button1_2 = makeClassicGestureButton(
...
private val _FASymbols_button2_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		bind(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("<")),
		bind(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive(":")),
private val _FASymbols_button2_1 = makeClassicGestureButton(
...
private val _FASymbols_button2_2 = makeClassicGestureButton(
