...
private val _ITMessagEase_button0_0 = makeClassicGestureButton(
...
private val _ITMessagEase_button0_1 = makeClassicGestureButton(
...
private val _ITMessagEase_button0_2 = makeClassicGestureButton(
	rowStart = 0, colStart = 2, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeStrings = caseSensitive("i")),
		gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("ì")),
		gesture(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("x")),
	)
)
private val _ITMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("ò")),
	)
)
private val _ITMessagEase_button1_1 = makeClassicGestureButton(
...
private val _ITMessagEase_button1_2 = makeClassicGestureButton(
...
private val _ITMessagEase_button2_0 = makeClassicGestureButton(
	rowStart = 2, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeStrings = caseSensitive("t")),
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("ó")),
...
private val _ITMessagEase_button2_1 = makeClassicGestureButton(
...
private val _ITMessagEase_button2_2 = makeClassicGestureButton(
