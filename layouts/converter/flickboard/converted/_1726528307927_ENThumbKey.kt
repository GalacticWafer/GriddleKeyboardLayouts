...
private val _ENThumbKey_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_DOWN_RIGHT, simpleInput, threeChars = caseSensitive("w")),
	)
)
private val _ENThumbKey_button0_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("g")),
	)
)
...
private val _ENThumbKey_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("m")),
	)
)
private val _ENThumbKey_button1_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP, simpleInput, threeChars = caseSensitive("q")),
		gestureSet(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("b")),
		gestureSet(SWIPE_LEFT, simpleInput, threeChars = caseSensitive("k")),
		gestureSet(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("p")),
		gestureSet(SWIPE_DOWN_LEFT, simpleInput, threeChars = caseSensitive("v")),
		gestureSet(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("x")),
		gestureSet(SWIPE_DOWN_RIGHT, simpleInput, threeChars = caseSensitive("y")),
	)
)
...
private val _ENThumbKey_button2_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("c")),
	)
)
private val _ENThumbKey_button2_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP, simpleInput, threeChars = caseSensitive("f")),
...
private val _ENThumbKey_button2_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP_LEFT, simpleInput, threeChars = caseSensitive("d")),
	)
)