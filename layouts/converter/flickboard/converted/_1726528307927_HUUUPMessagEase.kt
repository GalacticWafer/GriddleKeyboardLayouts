...
private val _HUUUPMessagEase_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("á")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ó")),
		gesture(SWIPE_DOWN_RIGHT, simpleInput, threeChars = caseSensitive("v")),
	)
)
private val _HUUUPMessagEase_button0_1 = makeClassicGestureButton(
...
private val _HUUUPMessagEase_button0_2 = makeClassicGestureButton(
...
private val _HUUUPMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ö")),
	)
)
private val _HUUUPMessagEase_button1_1 = makeClassicGestureButton(
...
private val _HUUUPMessagEase_button1_2 = makeClassicGestureButton(
...
private val _HUUUPMessagEase_button2_0 = makeClassicGestureButton(
	rowStart = 2, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeChars = caseSensitive("t")),
		gesture(SWIPE_UP, simpleInput, threeChars = caseSensitive("ű")),
		gesture(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("y")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ő")),
	)
)
private val _HUUUPMessagEase_button2_1 = makeClassicGestureButton(
...
private val _HUUUPMessagEase_button2_2 = makeClassicGestureButton(
