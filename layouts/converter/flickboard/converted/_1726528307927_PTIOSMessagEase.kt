...
private val _PTIOSMessagEase_button0_0 = makeClassicGestureButton(
	rowStart = 0, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeChars = caseSensitive("a")),
		gesture(SWIPE_UP, simpleInput, threeChars = caseSensitive("ô")),
		gesture(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("â")),
		gesture(SWIPE_LEFT, simpleInput, threeChars = caseSensitive("ã")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("à")),
		gesture(SWIPE_DOWN_RIGHT, simpleInput, threeChars = caseSensitive("v")),
	)
)
private val _PTIOSMessagEase_button0_1 = makeClassicGestureButton(
	rowStart = 0, colStart = 1, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeChars = caseSensitive("n")),
		gesture(SWIPE_UP, simpleInput, threeChars = caseSensitive("ñ")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("l")),
	)
)
private val _PTIOSMessagEase_button0_2 = makeClassicGestureButton(
	rowStart = 0, colStart = 2, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeChars = caseSensitive("i")),
		gesture(SWIPE_UP_LEFT, simpleInput, threeChars = caseSensitive("í")),
		gesture(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("õ")),
		gesture(SWIPE_DOWN_LEFT, simpleInput, threeChars = caseSensitive("x")),
	)
)
private val _PTIOSMessagEase_button1_0 = makeClassicGestureButton(
...
private val _PTIOSMessagEase_button1_1 = makeClassicGestureButton(
...
private val _PTIOSMessagEase_button1_2 = makeClassicGestureButton(
...
private val _PTIOSMessagEase_button2_0 = makeClassicGestureButton(
	rowStart = 2, colStart = 0, rowSpan = 1, colSpan = 1,
	gestureSet = mutableSetOf(
		gesture(CLICK, simpleInput, threeChars = caseSensitive("t")),
		gesture(SWIPE_UP, simpleInput, threeChars = caseSensitive("ú")),
		gesture(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("y")),
		gesture(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("ê")),
		gesture(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ó")),
	)
)
private val _PTIOSMessagEase_button2_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_LEFT, simpleInput, threeChars = caseSensitive("é")),
		gesture(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("z")),
	)
)
private val _PTIOSMessagEase_button2_2 = makeClassicGestureButton(
