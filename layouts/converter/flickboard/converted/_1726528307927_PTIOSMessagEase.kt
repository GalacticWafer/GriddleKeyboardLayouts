...
private val _PTIOSMessagEase_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP, simpleInput, threeChars = caseSensitive("ô")),
		gestureSet(SWIPE_UP_RIGHT, simpleInput, threeChars = caseSensitive("â")),
		gestureSet(SWIPE_LEFT, simpleInput, threeChars = caseSensitive("ã")),
		gestureSet(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("à")),
...
private val _PTIOSMessagEase_button0_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP, simpleInput, threeChars = caseSensitive("ñ")),
...
private val _PTIOSMessagEase_button0_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP_LEFT, simpleInput, threeChars = caseSensitive("í")),
		gestureSet(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("õ")),
...
private val _PTIOSMessagEase_button1_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gestureSet(SWIPE_UP, simpleInput, threeChars = caseSensitive("ü")),
		gestureSet(SWIPE_RIGHT, simpleInput, threeChars = caseSensitive("k")),
		gestureSet(SWIPE_DOWN, simpleInput, threeChars = caseSensitive("ç")),
	)
)
