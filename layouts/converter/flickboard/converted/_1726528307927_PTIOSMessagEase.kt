...
private val _PTIOSMessagEase_button0_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("ô")),
		gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("â")),
		gesture(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("ã")),
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("à")),
...
private val _PTIOSMessagEase_button0_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("ñ")),
...
private val _PTIOSMessagEase_button0_2 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("í")),
		gesture(SWIPE_RIGHT, simpleInput, threeStrings = caseSensitive("õ")),
...
private val _PTIOSMessagEase_button2_0 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("ú")),
		...
		gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("ó")),
	)
)
private val _PTIOSMessagEase_button2_1 = makeClassicGestureButton(
	...
	gestureSet = mutableSetOf(
		...
		gesture(SWIPE_LEFT, simpleInput, threeStrings = caseSensitive("é")),
