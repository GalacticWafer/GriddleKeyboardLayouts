...
object GriddleEnglishMap: GriddleKeyMap() {
    ...
    val englishA = button_0_0.replaceGesturesWith(
        ...
        gesture(SWIPE_UP,  simpleInput, oneString = "¨"),
        gesture(SWIPE_UP_RIGHT,  simpleInput, oneString = "~"),
        gesture(SWIPE_RIGHT, simpleInput, oneString = "!"),
        gesture(BOOMERANG_RIGHT, simpleInput, oneString = "¡"),
        gesture(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("$")),
        gesture(SWIPE_DOWN, simpleInput, oneString = "•"),
//        gesture(BOOMERANG_DOWN_LEFT, simpleInput, threeStrings = Triple("≤", "≥", "≥")),
        gesture(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = Triple("q", "Q", "Q")),
    ...
    val englishN = button_0_1.replaceGesturesWith(
        ...
        gesture(SWIPE_RIGHT, simpleInput, threeStrings = Triple("@", "ª", "ª")),
        gesture(BOOMERANG_RIGHT, simpleInput, threeStrings = Triple("ª", "@", "@")),
        gesture(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive("p")),
        gesture(BOOMERANG_DOWN_RIGHT, simpleInput, threeStrings = reversedCase("p")),
        gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("f")),
        gesture(BOOMERANG_DOWN, simpleInput, threeStrings = reversedCase("f")),
        gesture(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("w")),
        gesture(BOOMERANG_DOWN_LEFT, simpleInput, threeStrings = reversedCase("w")),
    ...
    val englishI = button_0_2.replaceGesturesWith(
        ...
        gesture(BOOMERANG_UP_LEFT, noOp, oneString = ""),
        gesture(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive("\u03B7")), // greek h "eta"
        gesture(BOOMERANG_DOWN_RIGHT, simpleInput, threeStrings = reversedCase("\u03B7")),

        gesture(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive("\u03B7")), // greek h "eta"
        gesture(BOOMERANG_DOWN_RIGHT, simpleInput, threeStrings = reversedCase("\u03B7")),
        gesture(SWIPE_LEFT, simpleInput, oneString = "#"),
...
//        gesture(CIRCLE_ANTI_CLOCKWISE, simpleInput, threeStrings = reversedCase("I")),
    ...
    val englishH = button_1_0.replaceGesturesWith(
        ...
        gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("ð")),
        gesture(BOOMERANG_DOWN, simpleInput, threeStrings = reversedCase("ð")),
...
//        gesture(CIRCLE_ANTI_CLOCKWISE, simpleInput, threeStrings = reversedCase("H")),
    ...
    val englishO = button_1_1.replaceGesturesWith(
        ...
        gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("x")),
        gesture(BOOMERANG_UP_LEFT, simpleInput, threeStrings = reversedCase("x")),
        gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("c")),
        gesture(BOOMERANG_UP, simpleInput, threeStrings = reversedCase("c")),
        gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("v")),
        gesture(BOOMERANG_UP_RIGHT, simpleInput, threeStrings = reversedCase("v")),
        gesture(SWIPE_RIGHT, simpleInput, oneString = "\""),
        gesture(SWIPE_DOWN_RIGHT, simpleInput, threeStrings = caseSensitive("y")),
        gesture(BOOMERANG_DOWN_RIGHT, simpleInput, threeStrings = reversedCase("y")),
        gesture(SWIPE_DOWN, simpleInput, threeStrings = caseSensitive("u")),
        gesture(BOOMERANG_DOWN, simpleInput, threeStrings = reversedCase("U")),
        gesture(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("l")),
        gesture(BOOMERANG_DOWN_LEFT, simpleInput, threeStrings = reversedCase("l")),
        gesture(SWIPE_LEFT, simpleInput, threeStrings = Triple("%", "%", "‰")),
        gesture(BOOMERANG_LEFT, simpleInput, threeStrings = Triple("‰", "%", "%")),
...
//        gesture(BOOMERANG_LEFT, simpleInput, threeStrings = reversedCase("C")),
    ...
    val englishR = button_1_2.replaceGesturesWith(
        ...
        gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("b")),
        gesture(BOOMERANG_UP_LEFT, simpleInput, threeStrings = reversedCase("b")),
        ...
        gesture(SWIPE_DOWN_LEFT, simpleInput, threeStrings = caseSensitive("å")),
        gesture(BOOMERANG_DOWN_LEFT, simpleInput, threeStrings = reversedCase("å")),
        gesture(SWIPE_LEFT, simpleInput, oneString = "'"),
...
//        gesture(BOOMERANG_LEFT, simpleInput, threeStrings = reversedCase("M")),
    ...
    val englishT = button_2_0.replaceGesturesWith(
        ...
        gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("þ")),
        gesture(BOOMERANG_UP, simpleInput, threeStrings = reversedCase("þ")),
        gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("k")),
        gesture(BOOMERANG_UP_RIGHT, simpleInput, threeStrings = reversedCase("k")),


        gesture(SWIPE_RIGHT, simpleInput, oneString = "&"),
        gesture(SWIPE_DOWN, simpleInput, oneString = "_"),
...
//        gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("\\")),
//        gesture(BOOMERANG_UP_LEFT, simpleInput, threeStrings = reversedCase("\\")),
//        gesture(SWIPE_LEFT, simpleInput, threeStrings = Triple("<", ">", ">")),
//        gesture(BOOMERANG_LEFT, simpleInput, threeStrings = Triple(">", "<", "<")),
    ...
    val englishE = button_2_1.replaceGesturesWith(
        gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("m")),
        gesture(BOOMERANG_UP_LEFT, simpleInput, threeStrings = reversedCase("m")),
        gesture(SWIPE_UP, simpleInput, threeStrings = caseSensitive("d")),
        gesture(BOOMERANG_UP, simpleInput, threeStrings = reversedCase("d")),

        gesture(SWIPE_UP_RIGHT, simpleInput, threeStrings = caseSensitive("ø")),
        gesture(BOOMERANG_UP, simpleInput, threeStrings = reversedCase("ø")),
        gesture(SWIPE_RIGHT, simpleInput, threeStrings = Triple("-", "–", "–")),
        ...
        gesture(SWIPE_LEFT, simpleInput, oneString = "*"),
        gesture(BOOMERANG_LEFT, simpleInput, oneString = "*"),
...
/*
    ...
    */
    val englishS = button_2_2.replaceGesturesWith(
        ...
        gesture(SWIPE_UP_LEFT, simpleInput, threeStrings = caseSensitive("æ")),
        gesture(BOOMERANG_UP_LEFT, simpleInput, threeStrings = reversedCase("æ")),
        gesture(SWIPE_UP, simpleInput, threeStrings = Triple("=", "±", "±")),
        gesture(BOOMERANG_DOWN, simpleInput, threeStrings = Triple("=", "±", "=")),
