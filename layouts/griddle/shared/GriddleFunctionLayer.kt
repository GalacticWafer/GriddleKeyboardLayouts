...
object DefaultFunctionMap: GriddleLayerBuilder() {
    ...
    val f1 = DefaultNumericMap.button1
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F1, appSymbol = F1_SYMBOL))

    val f2 = DefaultNumericMap.button2
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F2, appSymbol = F2_SYMBOL))

    val f3 = DefaultNumericMap.button3
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F3, appSymbol = F3_SYMBOL))

    val f4 = DefaultNumericMap.button4
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F4, appSymbol = F4_SYMBOL))

    val f5 = DefaultNumericMap.button5
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F5, appSymbol = F5_SYMBOL))

    val f6 = DefaultNumericMap.button6
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F6, appSymbol = F6_SYMBOL))

    val f7 = DefaultNumericMap.button7
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F7, appSymbol = F7_SYMBOL))

    val f8 = DefaultNumericMap.button8
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F8, appSymbol = F8_SYMBOL))

    val f9 = DefaultNumericMap.button9
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F9, appSymbol = F9_SYMBOL))

    val f10 = numericSpaceLeft
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F10, appSymbol = F10_SYMBOL))

    val f11 = DefaultNumericMap.button0
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F11, appSymbol = F11_SYMBOL))

    val f12 = numericSpaceRight
        .replaceGesturesWith(gesture(CLICK, PressKey, keycode = KEYCODE_F12, appSymbol = F12_SYMBOL))
